...
\item 2013, graduate research assistant testing CLAS12 Region II drift chambers at Old Dominion University clean room\\
\end{itemize}
\textbf{Publications:}\\
\begin{itemize}
...
%\input{texFiles/Intro/acknowledgments.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Motivation} 
\input{texFiles/Motivation/motivation.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Heavy Photon Search Experiment}
\input{texFiles/Experiment/experiment.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Detector Calibration and Performance} 
\input{texFiles/DetectorPerformance/performance.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Searching for displaced vertices}
\input{texFiles/Searching/searching.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Vertex Search Results} 
\input{texFiles/Results/results.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Conclusion}
...
\achapter{Contributions from other datasets}
